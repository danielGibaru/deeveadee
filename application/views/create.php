...
<html>
    ...
    <body>
        ...
        <form class="form-group row">
                <label for="numD" class="col-2 col-form-label">numD</label><br>
                <div class="col-10">
                    <input type="input" class='form-control' name="numD" value="<?= $Dvd['numD']; ?>"><br>
                </div>
                <label for="titreD" class="col-2 col-form-label">Titre du dvdeuhhhh</label>
                <div class="col-10">
